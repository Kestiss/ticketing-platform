...
data class CustomerOrder(
    val id: UUID, val organizationId: UUID, val eventId: UUID, val reservationId: UUID, val paymentProfileId: UUID,
    val customerEmail: String, val currency: String, val totalAmountMinor: Long, val status: OrderStatus,
    val createdAt: Instant, val updatedAt: Instant,
)

data class OrderItem(
    val id: UUID, val orderId: UUID, val ticketTypeId: UUID, val ticketTypeName: String, val quantity: Int,
    val unitPriceMinor: Long, val lineTotalMinor: Long, val createdAt: Instant,
)
